    ...
    <View onLayout={onLayoutRootView} style={styles.container}>
      <View style={styles.title}>
        <View style={styles.textContainer}>
          ...
          <Text style={styles.subTitleText}>Vamos começar a ensinar!</Text>
      ...
      <View style={[styles.titleContent, styles.elevation]}>
        <View style={styles.textTitleContent}>
          <Text style={styles.textBase}>Alunos</Text>
          <Link style={styles.linkMeusCursos} href="/userScire/meusCursos">Meus cursos</Link>
        </View>
        <View style={styles.progressClass}>
          <Text style={styles.minDone}>{minutosAssitidos}</Text>
          <Text style={styles.minGoal}>/60</Text>
        </View>
        <Progress.Bar progress={minutosAssitidos / 60} width={null} height={6} />
      </View>
      <View style={styles.card}>
        <Text style={styles.cardText}>Acompanhe suas aulas ou crie seu curso!!</Text>
        <View style={styles.viewImg}>
        <Image style={styles.imgCard} source={require("../../assets/homeprof.png")} />
          <Link href={"/userScire/cursosCriados"} asChild>
            <TouchableOpacity style={styles.buttonCard}><Text style={styles.textButtonCard}>Alunos</Text></TouchableOpacity>
          </Link>

          <Link href={"/userScire/cadastrarCurso"} asChild>
            <TouchableOpacity style={styles.buttonCard}><Text style={styles.textButtonCard}>Criar Cursos</Text></TouchableOpacity>
          </Link>
